    ...
    <>
      <HashRouter>
        <div style={{ padding: '0.1rem', maxWidth: '400px', margin: '0 auto' }}>
          ...
          <header style={{ display: 'flex', justifyContent: 'space-between', lineHeight: '1rem', alignItems: 'center', marginBottom: '0.1rem' }}>
            <h2>💱 Corazza CashTracker</h2>
            <button onClick={() => supabase.auth.signOut()} style={{ padding: '0.4rem' }}>Sair</button>
          </header>

          {/* Barra de Navegação Simples */}
          <nav style={{ display: 'flex', justifyContent: 'space-around', gap: '1rem', marginBottom: '0.2rem', paddingBottom: '0.2rem' }}>
